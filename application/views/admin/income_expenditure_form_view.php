        ...
        <div class="col-md-12" style="background-color: /*#f8f9f9 */ paleturquoise ; border-radius: 20px;">
            ...
            <div  class="col-md-4 col-md-offset-5">
                ...
                <form name="income_expense_form" id="income_expense_form" onsubmit="return(validate());"
                      action="<?php echo base_url('admin_controller/save_income_expenditure');?>"
                      method="POST">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="i_e_date" name="i_e_date">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Comment</label>
                            <input type="text" class="form-control" id="comment" name="comment"
                                   aria-describedby="emailHelp"  placeholder="Type Comment" >
                        </div>
                        <?php //echo form_error('head_id');?>
       ...
       // alert(xmlhttp.status);
        if (xmlhttp.readyState==4 && xmlhttp.status==200)
        {
           ...
           // alert(val.length);
            ...
            //alert(decodeURIComponent(jsonData));
            	//console.log(decodeURIComponent(jsonData[0].sub_head));
