    ...
    <div class="col-md-12" id="head" style="background-color:inherit ">
        <div class="col-md-12" style="background-color: /*#f8f9f9 */ paleturquoise ; border-radius: 20px;">
            ...
            <div  class="col-md-4 col-md-offset-5">
                ...
                <form action="<?php echo base_url('admin_controller/update_sub_head');?>"
                      method="POST">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="head_id" name="head_id" >
                                <option selected value="">Select Head </option>
                                <?php
                                foreach ($dropData as $d_data)
                                { ?>
<!--                                   // echo '<option value="'.$d_data->id.'"    >'.$d_data->head_name.'</option>';-->
                                <option value="<?=$d_data->id;?>" <?php if($d_data->id == $edata->head_id) echo 'selected="selected"'; ?> > <?php echo $d_data->head_name; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="sub_head_name" name="sub_head_name" value="<?php echo $edata->sub_head?>"
